...
@Operation(summary = "Guarda los detalles de venta", description = "Permite Guardar los detalle de venta")
    @PostMapping
    ...
    @Operation(summary = "Actusalizar los detalles de venta", description = "Permite actualizart los detalle de venta")
    @PutMapping("/{id}")
...
@Operation(summary = "listar los detalles de venta", description = "Permite listar los detalle de venta")
    @GetMapping
    ...
    @Operation(summary = "Buscar por ID los detalle de venta", description = "Busca por id")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "eliminar por ID los detalle de venta", description = "eliminar por id")
    @DeleteMapping("/{id}")
